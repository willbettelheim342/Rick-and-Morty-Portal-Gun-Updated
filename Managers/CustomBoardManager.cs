...
namespace Seralyth.Managers
{
    public class CustomBoardManager : MonoBehaviour
    {
        ...
        private static bool _customBoardsEnabled;
        public static bool CustomBoardsEnabled
        {
            get => _customBoardsEnabled;
            set
            {
                if (PortalOnlyMode.DisableCustomBoards)
                    value = false;
                ...
                {
                    foreach (GorillaNetworkJoinTrigger joinTrigger in PhotonNetworkController.Instance?.allJoinTriggers ?? Enumerable.Empty<GorillaNetworkJoinTrigger>())
                    {
                        try
                        {
        ...
        private static bool _customBoardTextEnabled;
        public static bool CustomBoardTextEnabled
        {
            get => !PortalOnlyMode.DisableCustomBoards && _customBoardTextEnabled;
            set => _customBoardTextEnabled = !PortalOnlyMode.DisableCustomBoards && value;
        }
        ...
        public static string motdTemplate = "Thanks for using my Rick and Morty portal gun.";
